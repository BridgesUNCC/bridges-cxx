...
class BSTElement : public BinTreeElement<E>
{
    ...
    public:
        ...
        virtual const string getDStype() const override {return "BinarySearchTree";}
        ...
        virtual BSTElement* getLeft() override {return static_cast<BSTElement*>(BinTreeElement<E>::getLeft());}
        /**
         * Constant version
         *
         * @return The left child
         */
        virtual const BSTElement* getLeft() const override {return static_cast<const BSTElement*>(BinTreeElement<E>::getLeft());}
        /**
         * Sets left to "l"
         *
         * @param l The left child
         */
        void setLeft(BSTElement* l){BinTreeElement<E>::setLeft(l);}
        /** @return The right child */
        virtual BSTElement* getRight() override {return static_cast<BSTElement*>(BinTreeElement<E>::getRight());}
        /**
         * Constant version
         *
         * @return The right child
         */
        virtual const BSTElement* getRight() const override {return static_cast<const BSTElement*>(BinTreeElement<E>::getRight());}
        /**
         * Sets right to "r"
         *
         * @param r The right BSTElement
         */
        void setRight(BSTElement* r){BinTreeElement<E>::setRight(r);}
    protected:
